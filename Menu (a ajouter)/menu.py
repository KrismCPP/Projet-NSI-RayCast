...
pygame.font.init()
pixelife_font = pygame.font.Font("pixellife.TTF", 50) #importation de police pixellife

def menu_principal():
    '''Importation et mise en place de l'image de fond du menu'''
    background = pygame.image.load('backroom_img.png')
...
def menu_arriver():
    '''Importation et mise en place de l'image de fond du menu'''
    background = pygame.image.load('sortie.png')
    screen.blit(background,(0,0))

    '''Creation du texte d'arriver'''
    arriver_text = pixelife_font.render('Vous etes sortis' , True , (255, 255, 255))
