# Créé par trist, le 17/04/2022 en Python 3.7
"""
...
Ajouter des murs autour de ce cette cellule , et mettre ces murs dans une liste
...
def generateur_laby(taille_laby):
    """Renvoie notre labyrinthe sous la forme d'une liste de liste"""
...
#########################################################################
    ...
    return laby,pos_depart
"""Fin de la fonction generateur_laby """


"""
laby = generateur_laby(10)
Affichage(laby)"""